...
arc_personas = open("personas.txt", "r")
for line in arc_personas:
        ...
        if (dato [0] == "Pasajero"):
            ...
            dato2 = dato[3].split("-")
            mi_pasajero.agregar_fecha_nacimiento(date (int(dato2[0]) ,int(dato2[1]) , int(dato2[2])))
            mi_pasajero.agregar_dni(dato[4])
            mi_pasajero.agregar_vip(dato[5])
            mi_pasajero.agregar_necesidades_especiales(dato[6])
            lista_personas.append(mi_tripulante)
            ...
            dato2 = dato[3].split("-")
            mi_piloto.agregar_fecha_nacimiento(date (int(dato2[0]) ,int(dato2[1]) , int(dato2[2])))
            ...
            mi_tripulante_servicio = piloto()
            mi_tripulante_servicio.agregar_nombre(dato[1])
            mi_tripulante_servicio.agregar_apellido(dato[2])
            dato2 = dato[3].split("-")
            mi_tripulante_servicio.agregar_fecha_nacimiento(date (int(dato2[0]) ,int(dato2[1]) , int(dato2[2])))
...
arc_aviones = open("aviones.txt", "r")
dato = arc_aviones.split("|")
mi_avion = aviones()
...
arc_vuelos = open("vuelos.txt", "r")
dato = arc_aviones.split("|")
mi_vuelo = vuelos()
mi_vuelo.agregar_avion(dato[0])
dato2 = dato[1].split("-")
mi_vuelo.agregar_fecha(date (int(dato2[0]) ,int(dato2[1]) , int(dato2[2])))
